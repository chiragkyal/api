...
var map_ControlPlaneMachineSetSpec = map[string]string{
	...
	"machineNamePrefix": "MachineNamePrefix is the prefix used when creating machine names. The prefix will be suffixed by a randomly generated string of 5 characters and the index of the machine. The prefix must not end with a special character, and only '-' is allowed in the middle.",
